...
function default_lineup(){
    ...
    document.getElementById('tactics-explainer').innerHTML = "England's usual formation, which lost them the Euro 2020 Finals match. England scored a goal 2 minutes after kickoff, but managed just 1 shot on target the rest of the match. Trent-Alexander Arnold did not play, while <span id ='red-span'>Mason Mount</span> and <span id='red-span'>Harry Kane</span> (highlighted in <span id ='red-span'>red</span>) performed poorly. This formation is relatively conservative, especially given the players England used -- they fielded a team with 5 defenders instead of the usual 4. Their outside defenders (Luke Shaw and Kyle Walker) were tasked with shutting down wide options for Italy. This left England with scant attacking options when they received the ball.";
}
...
function new_lineup(){
    ...
    document.getElementById('tactics-explainer').innerHTML = "This formation would allow England to attack aggressively and maintain a higher average field position. It would also play to the strengths of our key players, highlighted in <span id ='blue-span'>blue</span>. <span id ='blue-span'>Trent Alexander-Arnold</span>, whose absence in the Euro 2020 Final was sorely missed, can unlock oppositions with incredible passes. Allowing him to occupy the right channel plays to his strengths. Meanwhile, <span id='blue-span'>Mason Mount</span> shifts to a directly central role in the midfield right behind <span id = 'blue-span'>Harry Kane</span>. This provides him with more chances to shoot and also an easy way to interchange alongside Kane and the rest of the midfield.";
}