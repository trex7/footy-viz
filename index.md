	...
	<div class="container" id = "image-container">
		<div class="row">
			<div class="col">
				...
				-->	
				<input type="image" src="https://raw.githubusercontent.com/timschott/footy-viz/main/extra/default-tactics-board.png" style="opacity: 0.6;" onclick="default_lineup()"  onmouseout="this.style.opacity=0.6;" onmouseover="this.style.opacity=1;"/>
