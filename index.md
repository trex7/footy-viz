	...
	<div class="container" id = "image-container">
		<div class="row">
			<div class="col">
				...
				-->	
				<input type="image" src="images/default-tactics-boards.png" style="opacity: 0.6;" onclick="default_lineup()"  onmouseout="this.style.opacity=0.6;" onmouseover="this.style.opacity=1;"/>
